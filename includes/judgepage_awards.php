<h4 id="title"><i>Major Awards</i></h4>
<br />
  ...
  <table>
    <tr>
      <td><p align="center"> <b><font size="-1">CANDIDATES</font></b></p></td>
        <?php
        $mjrCat=select("majorcategories ORDER BY  `majorcategories`.`sort` ASC");
    ...
    <tr>
      ...
      <td align="center">
        <input type="text" class="textfield" placeholder="+<?php echo $mjr[2]; ?>%" onkeyup="checkValue(this, <?php echo $mjr[2]; ?>);"
            <?php
                $findScore=findData("major_result", "category", $mjr[1], "judge", $_GET['judge'], "candidate", $i);
            ...
            ?>  onchange="ajaxScore('includes/upgrade/processor.php?type=majorCategory&judge=<?php echo $_GET['judge']; ?>&candidate=<?php echo $i; ?>&category=<?php echo $mjr[1]; ?>');" 
